...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" ">
  ...
  <body oncontextmenu="return false" class="snippet-body">
    <div class="container d-flex justify-content-center">
      <div class="card  custom-record mt-5 px-3 py-4">
        <div class="d-flex flex-row justify-content-around">
          <a href="tinyrequest.php" class="tab">
        ...
        <img src="img/products/57.jpg" class="mr-3" height="75" />
          <div class="media-body">
              <br>
            <h5 class="mt-1">Transaction Records</h5>
          </div>
        </div>
    ...
    $conn = mysqli_connect("localhost","root","","furnstore");

    $query1= mysqli_query($conn,"SELECT*from mdata");
    while($row=mysqli_fetch_array($query1))
    {
        ?>
                    <tr>
                        <td style="color:black;"><?php echo $row['Tr_ID']; ?></td>
